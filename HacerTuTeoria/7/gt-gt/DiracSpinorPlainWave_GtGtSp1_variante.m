...
% La idea es sacar el Phi orignal y luego aplicarlo a los dos, las matrices
% de Pauli son sus propias inversas.
Phi_ori = PauliVectorEscalarProd(p)*Sp1.' / norm_p^2;

Sp1_control = PauliVectorEscalarProd(p) * Phi_ori;
Sp2 = (E - 1) * Phi_ori;
