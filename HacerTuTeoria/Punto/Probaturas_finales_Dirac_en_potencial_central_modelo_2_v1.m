...
dPhi_e1 = ObtenDerivadaDirNoRadialSpinorPequeno(bispinor, spinor_base, dir_e1, r, Z, cte_fina, factor_gamma_wiki);
dPhi_e2 = ObtenDerivadaDirNoRadialSpinorPequeno(bispinor, spinor_base, dir_e2, r, Z, cte_fina, factor_gamma_wiki);
...
Contrib_H_Q = ObtenAportacionHamiltonianoDerivadasEspaciales(bispinor, dPhi_dx, dPhi_dy, dPhi_dz, h_bar, c)

E_V = -c_elec/(4*pi*perme) * c_elec / r;
A = [E_V, 0, 0,0 ];

Contrib_H_V = ObtenAportacionHamiltonianoPotencial(E_V, jt)
...
function dPhi_dir_comple = ObtenDerivadaDirNoRadialSpinorPequeno(bispinor, spinor_base, dir_comple, r, Z, cte_fina, factor_gamma_wiki) 
